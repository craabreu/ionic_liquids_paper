...
The solvation free energy results at infinite-dilution condition suggest that a more favorable solvation of \ce{CO_2} occurs in \ce{[emim][B(CN)_4]} than in \ce{[emim][Tf_2N]}, despite the similarity in the Henry's law constants observed in both cases.
