...
The electrostatic interactions, on the other hand, can be linearly scaled by a coupling parameter $\lambda_\text{Coul}$ \cite{Naden_2015}, meaning that $V_\text{Coul}(r) = V_\text{Coul} V_\text{DSF}(r)$.
...
\begin{table}
	\centering
	\caption{Thermodynamic conditions employed in the solvation study at high concentrations of \ce{CO_2} in \ce{[emim][B(CN)_4]} and \ce{[emim][NTf_2]}, based on the experimental observations of Refs.~ \citenum{Makino_2014} and \citenum{Schilderman_2007}.}
	\begin{tabular}{ccc}
		\hline\hline
...
The model of Koller \textit{et al}. \cite{Koller_2012} was the one employed for \ce{[emim][B(CN)_4]}.
The computed solvation free energies for the systems \ce{CO_2}+\ce{[emim][B(CN)_4]} and \ce{CO_2}+\ce{[emim][NTf_2]} were $-0.755 \pm 0.01 ~\mathrm{kcal/mol}$ and $-0.542 \pm 0.005~\mathrm{kcal/mol}$, respectively.
...
The dotted lines correspond to the experimental values (i.e. the ones used to simulate the liquid solutions).
First, the results make clear that assuming ideal gas would have been an oversimplification, specially in the case of \ce{[emim][NTf_2]}.
Second, the computed pressures did not depart considerably from the specified values, meaning that our results sustain the experimental observation that $P$ is considerably lower for the system \ce{CO_2}+\ce{[emim][B(CN)_4]} than for the system \ce{CO_2}+\ce{[emim][NTf_2]}.
