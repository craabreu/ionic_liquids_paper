...
The differences in the \ce{CO_2} molar fractions in this case exemplifies the observation made by Carvalho \textit{et al.} \cite{Carvalho_2016}, mentioned at the introduction of this paper.
...
The solvation free energies obtained for \ce{CO_2}-\ce{[emim][B(CN)_4]} and \ce{CO_2}-[emim][Tf\textsubscript{2}N] were -0.755 $\pm$ 0.01 kcal/mol and -0.542 $\pm$ 0.005, respectively. However, since we employed a different molecule number of \ce{CO_2}, we cannot draw any conclusion regarding the presence of strong interactions with \ce{[emim][B(CN)_4]} that could explain the higher solubility.
...
It should be remarked that the different models presented a different behavior, as well; reflecting ?
...
However, this picture completely changes at high concentrations: the simulations correctly predicted a considerable lower pressure to dissolve a certain mass of \ce{CO_2} in \ce{[emim][B(CN)_4]}.

Finally, we employed the model of Koller \textit{et al.} \cite{Koller_2012} to predict infinite-dilution activity coefficient of various solutes.
In this case, the results were not satisfactory given the high errors associated to the free energy calculations of the pure solutes, making necessary a revision of the force fields for the solutes in a future work.
