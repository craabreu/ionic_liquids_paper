...
In Fig. we present the results of each iteration according to the scheme proposed in Sec. \ref{sec:partial_pressure}. The predicted values of pressure ($P_s$) reproduce what is observed experimentaly, in the sense that $P_s$ for the system \ce{CO_2}-\ce{[emim][B(CN)_4]} is considerably smaller than the value obtained for \ce{CO_2}-[emim][Tf\textsubscript{2}N].
